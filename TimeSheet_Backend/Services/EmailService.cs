        ...
        public class EmailService : IEmailService
        {
            public async Task SendVerificationEmailAsync(string email, string verificationToken)
            {
                try
                {
                    ...
                    Response += "<h1>OTP</h1>";
                    Response += $"<h2 style=\"font-size:50px;\">{verificationToken}</h2>";
                    Response += "<img style=\"width:70%\" src=\"https://business.adobe.com/customer-success-stories/media_11b3d9bfc1f37e690484ef1959da5c9eca88f96a3.png?width=750&format=png&optimize=medium\"/>";
                    Response += "</div>";
